...
public partial class SignUpPage : ContentPage
{
    ...
    {
        if (NameEntry.Text != null && EmailEntry.Text != null && EmailEntry.Text.Contains("@") && PasswordEntry.Text != null && ConfirmPasswordEntry.Text != null && PasswordEntry.Text == ConfirmPasswordEntry.Text)
        {
